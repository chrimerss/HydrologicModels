...
def FLEXtopo( ParPlateau, ParHillslope, ParWetland, ParCatchment,forcing, landscapes):
	...
	for t in range(0,tmax):
		...
		# Slow Reservoir
		Ss[t]=Ss[t]+ Fluxes_plateau[t,3]*dt * landscapes[2] + Fluxes_hillslope[t,3]* landscapes[0]*dt
		Qsdt= dt*Ks*Ss[t] 
		Ss[t]=Ss[t]-min(Qsdt,Ss[t])
		if t<tmax-1:
			Ss[t+1]=Ss[t]

		Qtotdt[t]=Qsdt + Fluxes_hillslope[t,2] * landscapes[0] +Fluxes_plateau[t,2] * landscapes[2] +  Fluxes_wetland[t,2]* landscapes[1]
